...
interface NewTextAreaFieldType {
    label?: string;
    inputImg?: FC;
    height: string;
    labelClass?: string;
...
function NewTextAreaField(
    props: NewTextAreaFieldType & FieldHookConfig<string>
) {
...
NewTextAreaField.defaultProps = {
    height: "100px",
};

export default NewTextAreaField;
